...
function systemPrompt(nowIso: string, timezone: string): string {
  return [
    ...
    "For people, places and organizations, description explains their relevance to this note, not general trivia.",
    ...
    "topics: 1 to 5 short thematic tags, lowercase. A topic is only a name and confidence; do not describe it.",
